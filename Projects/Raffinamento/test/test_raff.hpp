...
TEST(testBisezioneFunc,testBisezioneT1vert)
{
    ...
    array<unsigned int, 3> idVT1Giusto={50, 55, 89};
 ...
 TEST(testBisezioneFunc,testBisezioneT1lati)
 {
    ...
    array<unsigned int, 3> idlT1Giusto={142, 232, 233};
...
// TEST TRIANGOLO T2
 TEST(testBisezioneFunc,testBisezioneT2vert)
 {
    ...
    array<unsigned int, 3> idVT2Giusto={47, 55, 89};
 ...
 TEST(testBisezioneFunc,testBisezioneT4vert)
 {
    ...
    array<unsigned int, 3> idVT4Giusto={50, 49, 89};
 ...
 TEST(testBisezioneFunc,testBisezioneT4lati)
 {
    ...
    array<unsigned int, 3> idlT4Giusto={141, 235, 233};
 ...
 TEST(testBisezioneFunc,testBisezioneT5vert)
 {
    ...
    array<unsigned int, 3> idVT5Giusto={47, 49, 89};
 ...
 TEST(testBisezioneFunc,testBisezioneT5lati)
 {
    ...
    array<unsigned int, 3> idlT5Giusto={140, 235, 234};
